...
import { Redirect } from "@/app/hooks/Redirect";
                        ...
                        <div className="flex flex-col items-center space-y-4 text-center">
                            <div className="space-y-2">
                                ...
                                <p className="mx-auto max-w-[700px] text-gray-400 md:text-xl">
                                    Track, analyze, and optimize your personal expenses with our
                    ...
                    <div className="container mx-auto px-4 md:px-6">
                        ...
                        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 justify-items-center">
                            ...
                            <div className="flex flex-col items-center space-y-2 border border-gray-700 p-6 rounded-lg bg-gray-800 max-w-sm w-full">
                                ...
                                <p className="text-sm text-gray-400 text-center">
                                    Your financial data is encrypted and protected with the latest
                                    security measures.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col items-center space-y-4 text-center">
                            <div className="space-y-2">
                                ...
                                <p className="mx-auto max-w-[600px] text-gray-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                    ...
                                    finances. Sign up now and get a 30-day free trial.
                                </p>
                            </div>
            ...
            <footer className="w-full py-6 border-t border-gray-800">
                <div className="container mx-auto px-4 md:px-6">
                    <div className="flex flex-col sm:flex-row justify-between items-center">
                        <p className="text-xs text-gray-400">
                            © 2023 Personal Expense Tracker. All rights reserved.
                        </p>
